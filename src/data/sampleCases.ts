...
export const sampleCases: SurgicalCase[] = [
  {
    ...
    equipment: {
      store: ['Trocar 10mm x2, 5mm x2', 'Laparoscopic grasper x2', 'Clip applier (medium/large)', 'Endo-loop', 'Specimen retrieval bag', 'Veress needle / optical trocar'],
      room: ['Laparoscopic tower + light source', 'Insufflator CO₂', 'Electrocautery unit', 'Suction machine', 'Patient warming system', 'Video monitor x2'],
      basket: ['Scalpel blade #11', 'Raytec x4', 'Gauze 4x4', 'Syringe 10ml (saline flush)', 'Needle holder', 'Suture 3-0 silk (port closure)'],
    },
  ...
  },
  {
    ...
    equipment: {
      store: ['TKA instrument set (complete)', 'Femoral & tibial trial components', 'Final implant (ordered size)', 'Bone cement + gun (if cemented)', 'Pulse lavage system', 'Wound closure set'],
      room: ['Orthopedic traction table', 'Tourniquet machine', 'C-arm fluoroscopy', 'Electrocautery', 'Suction + irrigation', 'Power tools (saw, reamer)'],
      basket: ['Mayo stand cover', 'Raytec x6', 'Electrocautery tip', 'Suction tip', 'Retractors', 'Count sheet'],
    },
  ...
  },
  {
    ...
    equipment: {
      store: ['C-section instrument set', 'Uterine suture (0-Vicryl, 2-0 Vicryl)', 'Blake drain (optional)', 'Foley catheter set', 'Neonatal cord clamp set', 'Uterotonic medications'],
      room: ['OB delivery table', 'Infant radiant warmer', 'Fetal monitor (pre-op)', 'Suction', 'Electrocautery', 'Anesthesia machine'],
      basket: ['Mayo stand instruments', 'Raytec x8', 'Kelly clamps x4', 'Suction tip', 'Needle holder', 'Sponge sticks'],
    },
